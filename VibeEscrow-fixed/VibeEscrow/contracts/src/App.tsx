  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        {successTx && (
          <div className="alert alert-success">
            ✅ Transaction sent!{" "}
            <a href={`https://explorer.opnet.org/tx/${successTx}`} target="_blank" rel="noreferrer" className="alert-link">
        ...
        {wallet.connected && (
          <div className="tabs">
            <button className={`tab ${!createTab ? "tab-active" : ""}`} onClick={() => setCreateTab(false)}>
              Look Up Escrow
            </button>
            <button className={`tab ${createTab ? "tab-active" : ""}`} onClick={() => setCreateTab(true)}>
              + New Escrow
            </button>
          </div>
        )}
        ...
        {esc.error && <div className="alert alert-error">⚠️ {esc.error}</div>}
        ...
        {!wallet.connected && (
          <div className="onboarding">
            ...
            <p>
              Lock BTC or OP_20 tokens between buyer &amp; seller.<br />
              Funds release only when <strong>both parties approve</strong>.<br />
              Auto-refund after 7 days if no deal.
            </p>
      ...
      <footer className="footer">
        ...
        <a href="https://github.com/Vadya05/VibeEscrow" target="_blank" rel="noreferrer">GitHub →</a>
      </footer>
    </div>
  );
}
